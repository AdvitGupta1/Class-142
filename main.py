...
from storage import liked_movies, all_movies, not_liked_movies, did_not_watch
...
def popular_movies():
    ...
    for movie in output:
        _d = {
            "title" : all_movies[0],
            "poster_link" : all_movies[1],
            "release_date" : all_movies[2] or"N/A",
            "duration" : all_movies[3],
            "rating" : all_movies[4],
            "overview" : all_movies[5]
        }
